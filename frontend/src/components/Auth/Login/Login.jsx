...
function Login({ submitHandler, changeHandler, onToggleMode, isLoading, isDemoLoading, onDemoLogin }) {
  const busy = isLoading || isDemoLoading;
  return (
    <div className="loginCont">
      <h2>Login to <span>World of Formula</span></h2>
      <p className="authFormDesc">
        Access your account to dive into the exhilarating world of Formula 1 diecast models.
      </p>
